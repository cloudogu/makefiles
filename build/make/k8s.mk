...
K3S_CLUSTER_FQDN?=k3ces.localhost
...
# If KUBE_CONTEXT_NAME is empty and RUNTIME_ENV is not "remote" the "k3ces.localhost" is used as kube-context.
ifeq (${KUBE_CONTEXT_NAME}, )
	ifeq (${RUNTIME_ENV}, remote)
		KUBE_CONTEXT_NAME = $(shell kubectl config current-context)
	else
		KUBE_CONTEXT_NAME = k3ces.localhost
	endif
endif
