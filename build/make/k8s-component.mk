...
component-apply:
	...
	check-k8s-namespace-env-var ${COMPONENT_PRE_APPLY_TARGETS} ${IMAGE_IMPORT_TARGET} helm-generate helm-chart-import component-generate \ ## Applies the component yaml resource to the actual defined context.
